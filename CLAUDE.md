...
## Nächster Schritt
Etage 4 – Archiv der Stimmen ausbauen (Kristall-Verteilung interaktiver gestalten),
danach Etage 5 – Sanctum (Mira-Konfrontation + Aldric-Fragen + finale Entscheidung).
Vorlage je Etage: (1) Story-Events mit Verzweigungen → (2) interaktives Element im
Rätsel-Tab + Server-Logik → (3) DM-Übersicht/Lösung.
